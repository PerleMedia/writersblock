...
function generate(){
    ...
    document.getElementById('person').innerText = personOne;
    document.getElementById('extension').innerText = extension;
    document.getElementById('interaction').innerText = interaction;
    document.getElementById('person-2').innerText = personTwo;
    document.getElementById('extension-2').innerText = extensionTwo;
